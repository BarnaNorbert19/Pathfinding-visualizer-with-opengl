...
namespace Pathfinding.AStar
{
    public class AStar : PathfindingBase
    {
        ...
        public override async Task<IEnumerable<INode>> FindPathNoDiagonal(GridInfo meshInfo)
        {
        ...
        public override async Task<IEnumerable<INode>> FindPathDiagonal(GridInfo meshInfo)
        {
            var unvisited = new List<AStarNode>();
            var visited = new List<AStarNode>();
